...
define('ember-app/controllers/i-i-s-prilozhenie-03-\u0444\u0430\u043A\u0442-\u0432\u044B\u043F\u043E\u043B-\u0440\u0430\u0431-e', ['exports', 'ember-flexberry/controllers/edit-form'], function (exports, _editForm) {
  ...
  exports.default = _editForm.default.extend({
    ...
    getCellComponent: function getCellComponent(attr, bindingPath, model) {
      ...
      if (attr.kind === 'belongsTo') {
        switch (model.modelName + '+' + bindingPath) {
          case 'i-i-s-prilozhenie-03-т-ч-факт-вып-р+статьиЗатрат':
            cellComponent.componentProperties = {
              choose: 'showLookupDialog',
              remove: 'removeLookupValue',
              displayAttributeName: '',
...
define('ember-app/mixins/regenerated/models/i-i-s-prilozhenie-03-\u0442-\u0447-\u0444\u0430\u043A\u0442-\u0432\u044B\u043F-\u0440', ['exports', 'ember-data', 'ember-cp-validations', 'ember-flexberry-data/utils/attributes'], function (exports, _emberData, _emberCpValidations, _attributes) {
  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    modelClass.defineProjection('ТЧФактВыпРE', 'i-i-s-prilozhenie-03-т-ч-факт-вып-р', {
      ...
      спрНомен: (0, _attributes.belongsTo)('i-i-s-prilozhenie-03-спр-номен', 'Номенклатура', {
        наименование: (0, _attributes.attr)('Номенклатура', { index: 3 })
      ...
      обРаб: (0, _attributes.attr)('Объем работы', { index: 8 }),
      спрТранспСр: (0, _attributes.belongsTo)('i-i-s-prilozhenie-03-спр-трансп-ср', 'Транспортное средство', {
        наименование: (0, _attributes.attr)('Транспортное средство', { index: 10 })
      }, { index: 9, displayMemberPath: 'транспортное средство' }),
      спрТипТрансСр: (0, _attributes.belongsTo)('i-i-s-prilozhenie-03-спр-тип-транс-ср', 'Тип транспортного средство', {
        наименование: (0, _attributes.attr)('Тип транспортного средство', { index: 12 })
      }, { index: 11, displayMemberPath: 'тип транспортного средство' }),
      врПриб: (0, _attributes.attr)('Время прибытия', { index: 13 }),
      врУб: (0, _attributes.attr)('Время убытия', { index: 14 }),
      клЧасНОб: (0, _attributes.attr)('Количество часов на объекте', { index: 15 }),
      кдПрост: (0, _attributes.attr)('Код простоя', { index: 16 }),
      колЧасПр: (0, _attributes.attr)('Количество часов простоя', { index: 17 }),
      колЧасРаб: (0, _attributes.attr)('Количество часов работы', { index: 18 }),
      обГруз: (0, _attributes.attr)('Объем груза', { index: 19 }),
      спрЕдИзмер: (0, _attributes.belongsTo)('i-i-s-prilozhenie-03-спр-ед-измер', 'Единицы измерения', {
        наименование: (0, _attributes.attr)('Единицы измерения', { index: 21 })
		...
		exports.default = _offlineGlobals.default.extend({
				...
				getOfflineSchema: function getOfflineSchema() {
						...
						var returnedSchema = Ember.merge(parentSchema, {
								...
								'i-i-s-prilozhenie-03-т-ч-факт-вып-р': 'id,врПриб,врУб,кдПрост,клЧасНОб,колЧасПр,колЧасРаб,обГруз,обРаб,спрВидыРаб,спрЕдИзмер,спрКонтрАг,спрНомен,спрТипТрансСр,спрТранспСр,статьиЗатрат,фактВыполРаб',
