    ...
    public class СпрКонтрАг : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СпрКонтрАгE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СпрКонтрАгE", typeof(IIS.Prilozhenie_03.СпрКонтрАг));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СпрКонтрАгL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СпрКонтрАгL", typeof(IIS.Prilozhenie_03.СпрКонтрАг));
                }
            }
        }
    }
