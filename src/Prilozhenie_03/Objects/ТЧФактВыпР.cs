...
namespace IIS.Prilozhenie_03
{
    ...
    public class ТЧФактВыпР : ICSSoft.STORMNET.DataObject
    {
        ...
        /// ТЧФактВыпР.
        /// </summary>
        // *** Start programmer edit section *** (ТЧФактВыпР.СтатьиЗатрат CustomAttributes)

        // *** End programmer edit section *** (ТЧФактВыпР.СтатьиЗатрат CustomAttributes)
        [PropertyStorage(new string[] {
                "СтатьиЗатрат"})]
        [NotNull()]
        public virtual IIS.Prilozhenie_03.СтатьиЗатрат СтатьиЗатрат
        {
            get
            {
                // *** Start programmer edit section *** (ТЧФактВыпР.СтатьиЗатрат Get start)

                // *** End programmer edit section *** (ТЧФактВыпР.СтатьиЗатрат Get start)
                IIS.Prilozhenie_03.СтатьиЗатрат result = this.fСтатьиЗатрат;
                // *** Start programmer edit section *** (ТЧФактВыпР.СтатьиЗатрат Get end)

                // *** End programmer edit section *** (ТЧФактВыпР.СтатьиЗатрат Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (ТЧФактВыпР.СтатьиЗатрат Set start)

                // *** End programmer edit section *** (ТЧФактВыпР.СтатьиЗатрат Set start)
                this.fСтатьиЗатрат = value;
                // *** Start programmer edit section *** (ТЧФактВыпР.СтатьиЗатрат Set end)

                // *** End programmer edit section *** (ТЧФактВыпР.СтатьиЗатрат Set end)
            }
        }
